...
## Gotchas
### Password prompt with kde-wallet on linux / MacOS with chromium based browsers
This library may trigger a password prompt on systems when accessing browser cookies. 
